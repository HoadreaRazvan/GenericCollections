...
namespace GENERIC_COLLECTIONS
{
    public class Lista<T> : ILista<T> where T : IComparable<T>
    {
        ...
        public void adaugareInceput(T data)
        {
            if (head == null)
            {
                Nod<T> n = new Nod<T>();
        ...
        public void stergereData(T data)
        {
        ...
        public void modificareData(T dataInlocuit, T dataInlocuire)
        {
            this.adaugarePozitie(dataInlocuire, this.pozitieData(dataInlocuit));
            this.stergereData(dataInlocuit);
        }

        public void modificarePozitie(int index, T dataInlocuire)
        {
            this.adaugarePozitie(dataInlocuire, index);
            this.stergerePozitie(index + 1);
        }
        ...
        {
            int size = this.dimensiune();
            for (int i = 0; i < size; i++)
                this.stergerePozitie(0);
        }
